...
Triggered by `/silk-design <name>` or "build this like `<name>`". Match the arg loosely against the folder
name or the vertical — both resolve to one row.
...
## How to read a row
`folder` — vibe. Then palette / type / skin, the section **Flow**, and
...
row's skin, read `templates/<template>/theme.css` — a palette, a font, and three CSS recipes.
...
**`auto-detailing`** — dark, high-gloss, confident.
...
**`hvac-management`** — clean, trustworthy, corporate blue.
...
**`landscaping-services`** — fresh, natural, grounded.
...
**`plumbing-services`** — dark, technical, dependable.
...
**`roofing-company`** — dark, rugged, warm.
...
**`dental-practice`** — bright, precise, reassuring.
...
**`wellness-center`** — warm, data-driven, human.
...
**`natural-skincare`** — warm sand, organic, calm.
...
**`ai-consulting`** — dark, enterprise, neon-mint.
...
**`ai-email-platform`** — light blue, crisp, product-y.
...
**`ai-ugc-creator`** — light red, punchy, creator-energy.
...
**`saas-platform`** — dark purple, sleek, technical.
...
**`real-estate-agency`** — light, gold, premium.
...
**`luxury-real-estate`** — light, warm, cinematic.
...
**`boutique-hotel`** — dark, hushed, champagne luxury.
...
**`travel-agency`** — warm beige, editorial, indulgent.
...
**`creative-portfolio`** — clean white, monochrome, confident.
...
**`web-agency`** · digital agency — dark monochrome, bold, kinetic.
...
**`personal-blogger`** · travel blog — warm, playful, personal.
...
**`product-showcase`** · single chair — light neutral, minimal, single-object focus.
...
**`coffee-shop`** — cream & espresso, cozy, tactile.
...
**`perfume-brand`** — rose luxury, deep oxblood, sensual.
